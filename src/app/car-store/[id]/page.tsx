        ...
        >
          ...
          <div className="w-full py-6 md:w-1/2 relative overflow-hidden">
            ...
            <img
              ...
              className="absolute top-0 left-0  z-[-1] w-[350px] "
              alt=""
            />
            <div className="flex flex-col items-center z-50 justify-center">
              ...
              <div className="flex gap-3 w-[300px] items-center justify-between">
                <InfoItem
                  label={t("Car_Model")}
              ...
              <div className="flex gap-3 mt-4 w-[300px] items-center justify-between">
                <InfoItem
