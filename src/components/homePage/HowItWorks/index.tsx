  ...
  const steps = [
    ...
    },
    {
      ...
      description: {
        ...
        en: "Confirm your booking and let our team handle the rest.",
      },
    },
    {
      ...
      description: {
        ...
        en: "Monitor your shipment in real-time with live tracking updates.",
      },
    },
  ];
  return (
      ...
      <div className="w-full">
        <div className="flex flex-col item-center justify-center gap-1">
          <h1 className="font-bold text-3xl text-center">
            {isArabic ? "كيف تعمل المنصة" : "Steps section"}
          </h1>
